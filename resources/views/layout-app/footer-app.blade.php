            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    <li class="flex items-start gap-2">
                        ...
                        <span>Kantor Desa Pancaroba Sungai Ambawang</span>
                    </li>
                    <li class="flex items-center gap-2">
                        ...
                        <a href="mailto:sekertariat@pancaroba.desa.id" class="hover:text-white transition-colors">sekertariat@pancaroba.desa.id</a>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="w-4 h-4 shrink-0 text-brand-400" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
