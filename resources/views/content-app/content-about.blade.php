    ...
    <section id="faq" class="bg-white py-20">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <span class="text-xs font-bold tracking-widest uppercase text-brand-600 mb-2 block">Bantuan</span>
                <h2 class="font-extrabold text-3xl sm:text-4xl text-slate-900 tracking-tight">Pertanyaan Sering Ditanyakan</h2>
            </div>

            @foreach($faqs as $kategori => $items)
                <div class="mb-10">
                    <h3 class="text-xs font-bold uppercase tracking-widest text-brand-600 mb-4">{{ $kategori }}</h3>
                    <div class="space-y-3">
                        @foreach($items as $f)
                            <details class="bg-slate-50 rounded-2xl border border-slate-100 group">
            ...
            <div class="mt-4 text-center bg-slate-50 rounded-2xl border border-slate-100 p-8">
